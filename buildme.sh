...
# # mbedtls config (dependency for the secure ATF build)
# export MBEDTLSDIR=mbedtls
# export MBEDTLS_REPO=git@github.com:ARMmbed/mbedtls.git
# export MBEDTLS_TAG=mbedtls-2.8.0
...
# echo "Downoading mbedtls"
# if [[ ! -d $ROOTDIR/build/bootloader/$MBEDTLSDIR ]]; then
# 	cd $ROOTDIR/build/bootloader
# 	git clone $MBEDTLS_REPO
# 	cd $MBEDTLSDIR
# 	git fetch --tags
# 	git checkout -b $MBEDTLS_TAG $MBEDTLS_TAG
# fi
